...
%% Supplementary Fig. 11: Parameter scan
...
title(tl, ' ', 'FontSize', 20, 'FontWeight', 'bold');
xlabel(tl, 'Cluster size', 'FontSize', 20, 'FontWeight', 'bold');
ylabel(tl, '1 - CDF', 'FontSize', 20, 'FontWeight', 'bold');
...
for i = 1:numel(Dv)
    ...
    set(gca, 'Box', 'on', 'FontSize', 18, 'LineWidth', 1.5, 'YScale', 'log', 'XTick', 0:20:40, 'YTick', '');
    legend('Box', 'off', 'FontSize', 12);
    axis([0 60 0.01 30]);
end
set(gca, 'XTick', 0:20:60);
text(-120, 4.2e8, '\alpha = 0.99', 'FontSize', 20, 'FontWeight', 'bold', 'HorizontalAlignment', 'center')
text(0, 4.2e8, '\alpha = 0.9', 'FontSize', 20, 'FontWeight', 'bold', 'HorizontalAlignment', 'center')
