...
% Figure S3: A-P single exponentials
pd = 5;
figure(1); clf;
...
for v = [11 12 14 13 15 16]
    ...
    if mod(v, 10) == 1 || mod(v, 10) == 3
        set(gca, 'Box', 'on', 'FontSize', 20, 'LineWidth', 2, 'XTick', 0:20:40, 'YScale', 'log');
    else
        set(gca, 'Box', 'on', 'FontSize', 20, 'LineWidth', 2, 'XTick', 0:20:40, 'YScale', 'log', 'YTickLabel', '');
    end
    legend(TXT, 'Box', 'off', 'FontSize', 17);
    axis([0 60 YMI 2]);
end
